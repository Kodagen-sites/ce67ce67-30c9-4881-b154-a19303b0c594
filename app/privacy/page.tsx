    ...
    <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 md:px-8 md:pt-40">
      ...
      <div className="mt-12 space-y-8 leading-relaxed text-[var(--text-body)] [&_h2]:mb-3 [&_h2]:mt-10 [&_h2]:font-display [&_h2]:text-xl [&_h2]:text-ink [&_li]:opacity-90 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-6">
        ...
        <div>
          ...
          <ul>
            <li><strong>Information you provide</strong> — name, email, phone, address and any message you send through our contact or pickup-request forms.</li>
        ...
        <div>
          ...
          <ul>
            <li>To arrange pickups, deliveries and the laundry services you request.</li>
            <li>To respond to enquiries and keep you updated on your order.</li>
        ...
        <div>
          ...
          <p>
            ...
            who help us operate (such as hosting, delivery and analytics providers), and only
        ...
        <div>
          <h2>Your rights</h2>
          <p>
            You may have the right to access, correct or delete your personal information, or to
